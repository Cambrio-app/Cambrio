  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: const [
        ...
        BookListView(collectionToPull: 'books', collectionTitle: "Providentially Recommended", queryType: QueryTypes.random),
        BookListView(collectionToPull: 'books', collectionTitle: "Saved for Later", queryType: QueryTypes.alphabetical),
